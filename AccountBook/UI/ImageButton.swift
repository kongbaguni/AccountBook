    ...
    var body: some View {
        VStack {
            Button(action: action) {
                text.foregroundColor(.buttonStrockColor)
            }.background(
...
struct ImageButton_Previews: PreviewProvider {
    ...
    struct PreviewBtnView : View {
        var body : some View {
            VStack {
                ImageButton(imageUrl:  "https://lh3.googleusercontent.com/proxy/xNFsYBeWxLwCcjg8Qhjjj8fV9nRrEXCR64dwc_sX-9CFa6_mMuaUMgFTIw0fBLJkAFmM8pRpK66sHOLPdIawGExYXJcLc3jAxJkDVTrLBRVrdfBARA", placeHolderImage: Image("profile"), size: CGSize(width: 100, height: 100), text: Text("profile")) {
